...
class="datospersonales ">
    <h1 style="margin-bottom: 1rem " class="titulo titulo_info_personal">Información</h1>
        <div>
            <h2 class="subtitulo">Nombre: <span>{{$data['nombre1']}} {{$data['nombre2']}}</span></h2>
            <h2 class="subtitulo">Apellidos: <span>{{$data['apellido1']}} {{$data['apellido2']}}</span></h2>
            <h2 class="subtitulo">Cédula: <span>{{$data['cedula']}}</span></h2>
            <h2 class="subtitulo">Carnet: <span>{{$data['carnet']}}</span></h2>
            <h2 class="subtitulo">Correo: <span>{{$data['email']}}</span></h2>
            <h2 class="subtitulo">Fecha de nacimiento: <span>{{$data['fecha_Nacimiento']}}</span></h2>
