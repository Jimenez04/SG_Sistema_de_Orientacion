...
<p style="font-family:arial; 
 font-weight: 500;
text-indent: 0.5rem; color:black; font-size:0.8rem; line-height: 1.5rem; ">Se le informa que la solicitud con referencia: {{$solicitud->numero_Solicitud}}, ha cambiado de estado, su nuevo estado es: " {{$solicitud->estado}} ". La información se detalla a continuación.</p>

@if($solicitud->estado == 'Rechazado')
<p style="font-family:arial; 
 font-weight: 500;
text-indent: 0.5rem; color:black; font-size:0.8rem; line-height: 1.5rem; ">Razón de rechazo: "{{$status['descripcion_Rechazado']}}".  Puede realizar otra solicitud o bien visitar presencialmente las oficinas de orientación.</p>
@else
<p style="font-family:arial; 
 font-weight: 500;
text-indent: 0.5rem; color:black; font-size:0.8rem; line-height: 1.5rem; ">Mensaje de parte del orientador: "{{$status['mensaje']}}"</p>
@endif
